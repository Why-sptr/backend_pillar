...
<body>
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Tambah Data Ongkir</h6>
    </div>
    ...
    <div class="card-body">
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover table-striped">
          <form action="/insertongkir" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Asal</label>
              <input type="text" name="asal" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ old('asal') }}">
              @error('asal')
            ...
            <div class="form-group">
              <select class="form-control select2" style="width: 100%;" name="tujuan_id" id="tujuan_id" value="{{ old('tujuan_id') }}">
